...
bool libspdm_read_requester_public_certificate_chain(
    ...
    size_t *size, void **hash, size_t *hash_size)
{
    return get_certificate_chain(LIBSPDM_TPM_HANDLE_REQUESTER_CERTCHAIN_SLOT_0, base_hash_algo, req_base_asym_alg, data, size, hash,
...
bool libspdm_read_responder_public_certificate_chain(
    ...
    size_t *size, void **hash, size_t *hash_size)
{
    return get_certificate_chain(LIBSPDM_TPM_HANDLE_RESPONDER_CERTCHAIN_SLOT_0, base_hash_algo, base_asym_algo, data, size, hash, hash_size,
                                 false, true);
}
