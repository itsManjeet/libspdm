...
void *libspdm_ec_new_by_nid(size_t nid)
{
    ...
    // const char* point_conversion_forms = "uncompressed";
    ...
    // params[1] = OSSL_PARAM_construct_utf8_string(OSSL_PKEY_PARAM_EC_POINT_CONVERSION_FORMAT, (void*) point_conversion_forms, strlen(point_conversion_forms));
